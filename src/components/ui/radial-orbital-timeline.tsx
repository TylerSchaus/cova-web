        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-[#0066FF] via-[#0551ef] to-[#054bec] animate-pulse flex items-center justify-center z-10">
            ...
            <div className="w-12 h-12 rounded-full bg-black flex items-center justify-center overflow-hidden">
                <img src="/logo.png" alt="Cova Systems" className="w-7 h-7 object-contain" />
              </div>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className={`
                  ...
                  ${isExpanded ? "text-white scale-125 top-14" : "text-white/70 top-12"}
                `}>
                  {item.title}
                </div>
                        ...
                        <div className="mt-4 pt-3 border-t border-white/10">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {item.relatedIds.map((relatedId) => {
                              ...
                              const isPrevious = relatedId < item.id;
                              return (
                                <Button
                                  key={relatedId}
                                  variant="outline"
                                ...
                                >
                                  {isPrevious ? (
                                    <>
                                      <ArrowRight size={8} className="mr-1 text-white/60 rotate-180" />
                                      {relatedItem?.title}
                                    </>
                                  ) : (
                                    <>
